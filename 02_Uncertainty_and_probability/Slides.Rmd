...
.pull-left-wide[
- If $A$ and $B$ are statistically dependent, then typically either 
1. $A \rightarrow B$, 
2. $B \rightarrow A$, or 
...
> Consequence: If A and B are only depends via C, then 'controlling' for C should make A and B independent. If not, then there is a direct relationship between A and B.
