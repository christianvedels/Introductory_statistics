...
3. Let's hypothesis that $\sigma^2 = 9$. Does our result support this hypothesis?
...
#
# 3. Let's hypothesis that $\sigma^2 = 9$. Does our result support this hypothesis?
#    No — the entire CI is above 9, so 9 is not a plausible value for sigma^2 given the data
```
